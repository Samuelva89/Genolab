      ...
      try {
        ...
        for (const strain of allStrains) {
          try {
            ...
            allAnalyses.push(...analysesResponse.data);
          } catch (err) {
            // Si una cepa no tiene análisis o hay error, continuamos con la siguiente
            console.warn(`No se pudieron obtener análisis para la cepa ${strain.id}:`, err);
          }
        }
  ...
  return (
    <div className="bioinformatics-theme fade-in-up">
      <div className="bioinformatics-card">
        ...
        <h1><BioIcon type="chart" className="sidebar-icon" is3d /> Lista de Análisis</h1>
        {analyses.length === 0 ? (
